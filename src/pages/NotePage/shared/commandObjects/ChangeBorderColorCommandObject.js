...
export default class ChangeBorderColorCommandObject extends CommandObject {
   ...
   */
  undo() {
    console.log('undo border color: from ' + this.newValue + " to " + this.oldValue);
    this.targetObject.borderColor = this.oldValue;
    // maybe also need to fix the palette to show this object's color?
    this.undoHandler.changeCurrBorderColorState(this.targetObject.selectedShapeId ,this.oldValue);
  }
   ...
   */
  redo() {
    console.log('redo border color');
    this.targetObject.borderColor = this.newValue;
    // maybe also need to fix the palette to show this object's color?
    // becomeSelected(this.targetObject);
    this.undoHandler.changeCurrBorderColorState(this.targetObject.selectedShapeId ,this.newValue);
  }
