...
const controlContext = createContext({
  ...
  registerExecution: () => {},
  changeCurrFillColorState: () => {},
  changeCurrTextColorState: () => {},
  changeCurrBorderColorState: () => {},
  changeCurrBorderWidthState: () => {},
  UndoAddShape: () => {},
  RedoAddShape: () => {},
  DoMoveShape: () => {},
  DoChangeTextValue: () => {},
...
export class ControlContextProvider extends Component {
  state = {
    // controls
    ...
    return (
      <controlContext.Provider
        value={{
          ...
          setAnchorPoint: this.setAnchorPoint,
        }}
      >
        {children}
      </controlContext.Provider>
