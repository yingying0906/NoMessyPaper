...
const ColorSelector = ({currColorContex, setCurrColorContex, setCurrColorContexFin, IconObj}) => {
  ...
  const handleChange = (color) => {
    ...
    setCurrColorContex(`rgba(${ currColor.r }, ${ currColor.g }, ${ currColor.b }, ${ currColor.a })`);
  };

  const handleChangeFin = (color) => {
    setCurrColor(color.rgb);
    setCurrColorContex(`rgba(${ currColor.r }, ${ currColor.g }, ${ currColor.b }, ${ currColor.a })`);
    setCurrColorContexFin(`rgba(${ currColor.r }, ${ currColor.g }, ${ currColor.b }, ${ currColor.a })`);
  };
  ...
  return(
    <div>
        ...
        <div className="Mode" onClick={ handleClick }>
          <IconObj className="ButtonIcon" color={ currColorContex } />
        </div>
        { displayColorPicker ? <div style={ styles.popover }>
          <div style={ styles.cover } onClick={ handleClose }/>
          <SketchPicker color={ currColor } onChange={ handleChange } onChangeComplete={ handleChangeFin }/>
        </div> : null }
